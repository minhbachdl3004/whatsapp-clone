...
const ConversationScreen = ({
  ...
  const showMessages = () => {
    // if front-end is loading messages behind the scenes, display messages retrieved from
    // Next SSR (passed down from [id].tsx)
    if (messagesLoading) {
    ...
    // if front-end has finished loading messsages, so now we have messagesSnapshot
    if (messagesSnapshot) {
